                    ...
                    <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                        <div class="banner-img style-2">
                            <div class="banner-text">
                                <h2 class="mb-100">A Better <br> Life </h2>
                                        ...
                                        <div class="product-cart-wrap">
                                            <div class="product-img-action-wrap">
                                                ...
                                                <div class="product-action-1">
                                                    ...
                                                    <a aria-label="Add To Wishlist" class="action-btn small hover-up" href={{route('wishlist.page')}}><i class="fi-rs-heart"></i></a>
                                            ...
                                            <div class="product-content-wrap">
                                                ...
                                                <a href="{{route('cart.page')}}" class="btn w-100 hover-up"><i class="mr-5 fi-rs-shopping-cart"></i>Add To Cart</a>
                                            </div>
                                        </div>
                                        @endforeach
                                        <!--End product Wrap-->                                
